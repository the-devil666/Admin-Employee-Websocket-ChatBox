...
//    private Bucket bucket = Bucket4j.builder().addLimit(Bandwidth.classic(5, refill)).build();
    ...
    @GetMapping("/javatechie")
    public ResponseEntity<String> Chating() throws PWSException {
      ResponseEntity <String>  uri=restTemplate.exchange("http://localhost:8081/", HttpMethod.GET,null,String.class);
        return uri;
    }
